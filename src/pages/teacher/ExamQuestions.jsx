...
const changeQuestionType = (type) => {
  ...
  setQuestion({
    ...
    // نحافظ على الصورة والسؤال وباقي البيانات
  });
...
const addOption = () => {
  ...
  if (question.options.length >= 8) {
    ...
    alert("يمكن إضافة 8 اختيارات كحد أقصى");
...
const selectCorrect = (index) => {
  ...
  let answers = [...question.correctAnswers];
...
const createQuestion = async () => {
  ...
  if (Number(question.marks) < 1) {
    ...
    alert("درجة السؤال يجب أن تكون أكبر من صفر");
